...
class BluePage2 extends StatefulWidget {
  final Map arguments;
  BluePage2({Key? key, required this.arguments}) : super(key: key);

  @override
  State<BluePage2> createState() => _BluePage2State();
}

class _BluePage2State extends State<BluePage2> {
  //获取设备
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        TextField(
              maxLines: 2,
              obscureText: false,
              decoration: InputDecoration(hintText: "输入任何值"),
              onChanged: (value) {
                setState(() {
